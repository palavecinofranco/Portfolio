      ...
      <div data-aos="flip-up">
        ...
        <div data-aos="flip-up" data-aos-delay="200">
          <div className="project">
            ...
            <div className="project-links">
              ...
              <a href="https://react-nike-ecommerce.netlify.app/" target="_blank" rel="noreferrer">
        ...
        <div data-aos="flip-up" data-aos-delay="300">
          <div className="project">
            ...
            <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
            <div className="project-links">
              <a className="proyect-links-a" href="https://github.com/palavecinofranco/PeluqueriaCanina" target="_blank" rel="noreferrer">
                <img src={githubIcon} alt="GitHub" />
              </a>
            </div>
            </header>
        ...
        <div data-aos="flip-up" data-aos-delay="400">
          <div className="project">
            ...
            <div className="body">
              ...
              <p className="proyectp">Lading page para empresa estilo infantil utilizando HTML, CSS & Javascrip "puro".</p>
            </div>
            <footer className="proyect-footer">
              <ul className="tech-list">
                <li>HTML5</li>
